...
### 4. Check CI and review feedback

| Skill | When to use | How |
|-------|-------------|-----|
| **check-pr** | First check after opening PR or after pushing fixes | Ask Cursor: "run check-pr" — triages CI, review comments, and description |
...
**Typical flow:**
1. Open the PR and wait for CI.
2. Run **check-pr** to see what's actionable.
3. Fix issues and push again.
4. Run **code-simplifier** before final human review if the diff feels messy.
...
| Review comment seems wrong | Reply on the thread with your reasoning |
...
| check-pr | `.cursor/skills/check-pr/` | PR readiness checks |
